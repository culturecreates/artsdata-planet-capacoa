...
It also contains a workflow script to push **Showcase Events** data to the [showcase-events graph](https://kg.artsdata.ca/en/query/show?title=Event%20entities%20in%20showcase-events&sparql=list_events&graph=http://kg.artsdata.ca/capacoa/artsdata-planet-capacoa/showcase-events) in Artsdata using a JSON-LD file in the [showcase-events CAPACOA Github repo](https://github.com/capacoa/showcase-events). 
