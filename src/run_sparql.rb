...
prefixes = {
  ...
  skos:     RDF::Vocabulary.new("https://www.w3.org/2004/02/skos/core#"),
  capacoa:  RDF::Vocabulary.new("https://capacoa.ca/vocabulary#"),
  member:  RDF::Vocabulary.new("https://capacoa.ca/member/"),
  wikidata_property: RDF::Vocabulary.new("https://www.wikidata.org/prop/direct"),
  wikidata_entity: RDF::Vocabulary.new("https://www.wikidata.org/entity/"),
